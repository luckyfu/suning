...
//赋值……
$req->setActivityInfo("[{activityId:权益活动ID,activitySecretKey:权益活动秘钥,bonusTrigerId:奖励触发事件编号},{activityId:权益活动ID,activitySecretKey:权益活动秘钥,bonusTrigerId:奖励触发事件编号}]	");
