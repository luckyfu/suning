...
$req = new SaveminvoicereceiverCreateRequest();
//赋值……
$req->setAppId("appId");
$req->setCityCode("11");
...
$req->setDistrictCode("districtCode");
$req->setDistrictName("districtName");
$req->setMerchantCode("merchantCode");
$req->setProvCode("provCode");
$req->setProvName("provName");
$req->setTownCode("townCode");
$req->setTownName("townName");
