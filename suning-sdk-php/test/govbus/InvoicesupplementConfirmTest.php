...
$req = new InvoicesupplementConfirmRequest();
//赋值……
...
$applyForInvoiceReqDTO->setInvoiceContent("1");
$applyForInvoiceReqDTO->setInvoiceType("6");
$applyForInvoiceReqDTO->setMarkId("xxx1000000");
$applyForInvoiceReqDTO->setRegAccount("23235254664336");
$applyForInvoiceReqDTO->setRegAdd("江苏省南京市雨花区软件大道舜天集团");
$applyForInvoiceReqDTO->setRegBank("XXX银行");
$applyForInvoiceReqDTO->setRegTel("025-84797157");
$applyForInvoiceReqDTO->setRemark("XXXXXXX");
...
$orderInfoDTO->setGcItemNo("2342352433401");
