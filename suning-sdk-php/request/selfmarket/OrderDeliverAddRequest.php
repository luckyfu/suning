...
class OrderDeliverAddRequest  extends SuningRequest{
	...
	public function getDeliverGoodsNum() {
		return $this->deliverGoodsNum;
	}
	
	public function setDeliverGoodsNum($deliverGoodsNum) {
		$this->deliverGoodsNum = $deliverGoodsNum;
		$this->apiParams["deliverGoodsNum"] = $deliverGoodsNum;
	}
