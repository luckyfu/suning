...
class SearchcommodityQueryRequest  extends SuningRequest{
	...
	public function getSnfwservice() {
		return $this->snfwservice;
	}
	
	public function setSnfwservice($snfwservice) {
		$this->snfwservice = $snfwservice;
		$this->apiParams["snfwservice"] = $snfwservice;
	}
	
	public function getSnhwg() {
		return $this->snhwg;
	}
	
	public function setSnhwg($snhwg) {
		$this->snhwg = $snhwg;
		$this->apiParams["snhwg"] = $snhwg;
	}
